...
namespace thesis_UI1
{
    ...
    abstract public class Sensor
    {
        ...
        abstract public Sensor newSensorInstance(TimeSimulator timeSimulator, DataCenter mainForm); //mainForm could be null. Be Careful.
